...
namespace cinemaautomation
{
    public partial class frmyönetmen : Form
    {
        ...
        {
            this.Close(); //Application.Exit dersek anaformu da kapatır.Sadece üzerinden
            //bulunduğumuz formu kapatıyoruz.
        }
        ...
        public string cinsiyet = "0"; //Manuel değerimizi 0 yaptım.
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "" && textBox4.Text != "" && resimyolu != "")
            {
                ...
                baglanti.Open();
                SqlCommand kayit = new SqlCommand("insert into Yonetmenler (AdveSoyad,Cinsiyet,Yas,Biyografi,Resim) values (@AdveSoyad,@Cinsiyet,@Yas,@Biyografi,@Resim)", baglanti);
